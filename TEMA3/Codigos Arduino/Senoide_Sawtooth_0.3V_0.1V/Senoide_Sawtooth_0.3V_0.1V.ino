...
//variaveis globais
int i = 0; 
static byte WaveFormTable[2][Num_Samples] =  {
    // Sin wave
    {
...
void loop() {
  ...
  dacWrite(DAC1, (WaveFormTable[0][i]/8) ); //255 = 3.22V  0 = 0.09V
  Serial.print( (WaveFormTable[0][i]/8) ); Serial.print("\t");
  
  dacWrite(DAC2, WaveFormTable[1][i]/8 );   //255 = 3.22V  0 = 0.09V
  Serial.print( WaveFormTable[1][i]/8 ); //Serial.print("\t");
  Serial.println();
  i++;
