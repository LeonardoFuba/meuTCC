...
void setup(void) 
{
  ...
  //set for single ended
  //analogReference(INTERNAL);    /* seta a referencia interna */
  
  /*Legenda do grafico*/
  //Serial.println("A0\tA1\tA2\tA3\t"); 
  //Serial.println("RAW0\tRAW1\tRAW2\tRAW3\t");
  //Serial.println("AD0\tAD1\t");
...
void loop(void) 
{
  ...
  int16_t raw_ch0, raw_ch1, raw_ch2, raw_ch3; 
 ...
 // raw_ch3 = ads.readADC_SingleEnded(3);
  ...
  //leitura DIFFERENTIAL
  raw_ch0 = ads.readADC_Differential_0_1();
 // raw_ch1 = ads.readADC_Differential_2_3();
