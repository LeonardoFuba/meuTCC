...
void setup() {
  ...
  Serial.println("SIN\tTRI\tSAW\tQUA\t");
}

void loop() {
  
  dacWrite(25, (WaveFormTable[0][i]/4) ); //255 = 3.22V  0 = 0.09V
  Serial.print( (WaveFormTable[0][i]/4) );  Serial.print("\t");
  delay(2);
  
  dacWrite(25, WaveFormTable[1][i]/4 );   //255 = 3.22V  0 = 0.09V
  Serial.print( WaveFormTable[1][i]/4 );    Serial.print("\t");
  delay(2);
  
  dacWrite(25, (WaveFormTable[2][i]/4) ); //255 = 3.22V  0 = 0.09V
  Serial.print( (WaveFormTable[2][i]/4) );  Serial.print("\t");
  delay(2);
  
  dacWrite(25, WaveFormTable[3][i]/4 );   //255 = 3.22V  0 = 0.09V
  Serial.print( WaveFormTable[3][i]/4 );    Serial.print("\t");
  delay(2);
  Serial.println();
  i++;
